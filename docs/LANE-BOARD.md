...
Save_t/CARD fixture is now integrated and awaiting exact-path cleanup. No
...
verification tip is `f19c73f`, which adds the registered Save_t/CARD recovery
fixture on top of the V4 alpha-state CPU contract and typed Apple consumer
validation at `dbf6986`. Native and combined ASan/UBSan focused tests for the V4
